<!-- Modal -->
<div class="modal fade" id="editCountryModal" tabindex="-1" role="dialog" aria-labelledby="addCountryModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('update.countries.details')}}" method="POST" id="update-country-form">
                @csrf
